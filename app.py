...
# ── Datos de Origen: 83 Bloques Preliminares de Intervención ─────────
# Fuente: DATOS DE ORIGEN 83 BLOQUES.xlsx
# Cada entrada: (N, Bloque, Microcuenca, Area_ha, Provincia, Distrito, Accesibilidad, Dia)
BLOQUES_83 = [
    (1, "M25B1", "C1107-Q9541", 313.007, "Piura", "Las Lomas", 0, 1),
    (2, "M35B1", "C1107-Q9539", 244.529, "Sullana", "Sullana", 0, 1),
    (3, "M10B4", "C1096-Q9547", 365.749, "Morropón", "Chulucanas", 0, 2),
    (4, "M9B1", "C1096-Q9545", 1116.558, "Morropón", "Chulucanas", 0, 2),
    (5, "M5B3", "C1108-Q9552", 333.968, "Piura", "Tambo Grande", 0, 2),
    (6, "M5B1", "C1108-Q9552", 44.363, "Piura", "Tambo Grande", 1, 2),
    (7, "M8B5", "C1096-Q9558", 93.213, "Morropón", "Chulucanas", 1, 3),
    (8, "M17B1", "C1096-Q9556", 11.448, "Morropón", "Chulucanas", 0, 3),
    (9, "M27B1", "C1096-Q9557", 449.066, "Morropón", "Chulucanas", 0, 3),
    (10, "M10B1", "C1096-Q9547", 416.522, "Morropón", "Chulucanas", 0, 3),
    (11, "M17B6", "C1096-Q9556", 106.593, "Ayabaca", "Frías", 1, 4),
    (12, "M17B11", "C1096-Q9556", 819.771, "Morropón", "Chulucanas", 1, 4),
    (13, "M17B4", "C1096-Q9556", 425.034, "Morropón", "Chulucanas", 1, 4),
    (14, "M17B10", "C1096-Q9556", 924.365, "Ayabaca", "Frías", 1, 4),
    (15, "M17B5", "C1096-Q9556", 74.065, "Ayabaca", "Frías", 1, 4),
    (16, "M8B4", "C1096-Q9558", 58.489, "Morropón", "Chulucanas", 1, 4),
    (17, "M17B7", "C1096-Q9556", 258.969, "Ayabaca", "Frías", 1, 4),
    (18, "M36B2", "C1086-Q9576", 57.349, "Morropón", "Santa Catalina de Mossa", 0, 5),
    (19, "M29B1", "C1096-Q9564", 27.184, "Ayabaca", "Frías", 1, 5),
    (20, "M19B5", "C1086-Q9570", 33.614, "Morropón", "Santo Domingo", 1, 5),
    (21, "M36B1", "C1086-Q9576", 137.132, "Morropón", "Chalaco", 1, 5),
    (22, "M19B7", "C1086-Q9570", 68.867, "Morropón", "Santo Domingo", 1, 6),
    (23, "M19B2", "C1086-Q9570", 73.999, "Morropón", "Morropón", 1, 6),
    (24, "M8B2", "C1096-Q9558", 56.747, "Morropón", "Santo Domingo", 1, 6),
    (25, "M32B2", "C1086-Q9569", 82.209, "Morropón", "Santa Catalina de Mossa", 1, 6),
    (26, "M32B3", "C1086-Q9569", 98.628, "Morropón", "Morropón", 1, 6),
    (27, "M34B1", "C1078-Q9562", 738.048, "Morropón", "La Matanza", 0, 7),
    (28, "M8B1", "C1096-Q9558", 160.448, "Morropón", "Morropón", 0, 7),
    (29, "M27B4", "C1096-Q9557", 588.839, "Morropón", "Morropón", 0, 7),
    (30, "M16B3", "C1080-Q9560", 106.81, "Morropón", "Morropón", 0, 7),
    (31, "M16B2", "C1080-Q9560", 277.582, "Morropón", "Morropón", 0, 7),
    (32, "M27B5", "C1096-Q9557", 97.792, "Morropón", "Morropón", 0, 7),
    (33, "M6B10", "C1077-Q9566", 409.666, "Morropón", "Buenos Aires", 1, 8),
    (34, "M28B3", "C1086-Q9575", 178.072, "Morropón", "Yamango", 1, 8),
    (35, "M28B1", "C1086-Q9575", 245.908, "Morropón", "Yamango", 0, 8),
    (36, "M28B4", "C1086-Q9575", 283.543, "Morropón", "Yamango", 0, 8),
    (37, "M28B2", "C1086-Q9575", 90.228, "Morropón", "Yamango", 1, 8),
    (38, "M32B1", "C1086-Q9569", 434.48, "Morropón", "Buenos Aires", 1, 8),
    (39, "M6B6", "C1077-Q9566", 91.615, "Morropón", "Buenos Aires", 0, 9),
    (40, "M6B8", "C1077-Q9566", 62.066, "Morropón", "Buenos Aires", 0, 9),
    (41, "M6B7", "C1077-Q9566", 194.339, "Morropón", "Buenos Aires", 0, 9),
    (42, "M6B2", "C1077-Q9566", 2232.934, "Morropón", "Buenos Aires", 0, 9),
    (43, "M1B1", "C1077-Q9580", 426.891, "Morropón", "Buenos Aires", 0, 10),
    (44, "M18B1", "C1077-Q9579", 160.43, "Morropón", "Buenos Aires", 1, 10),
    (45, "M6B5", "C1077-Q9566", 228.134, "Morropón", "Buenos Aires", 0, 10),
    (46, "M18B3", "C1077-Q9579", 373.96, "Morropón", "Salitral", 0, 10),
    (47, "M18B5", "C1077-Q9579", 197.437, "Morropón", "Salitral", 0, 10),
    (48, "M3B9", "C1081-Q9582", 294.318, "Morropón", "Salitral", 1, 11),
    (49, "M3B8", "C1081-Q9582", 565.792, "Morropón", "San Juan de Bigote", 1, 11),
    (50, "M3B1", "C1081-Q9582", 81.014, "Morropón", "Salitral", 0, 11),
    (51, "M7B1", "C1076-Q9581", 130.475, "Morropón", "Salitral", 1, 11),
    (52, "M3B3", "C1081-Q9582", 84.855, "Morropón", "San Juan de Bigote", 1, 11),
    (53, "M11B1", "C1081-Q9583", 48.951, "Morropón", "San Juan de Bigote", 1, 12),
    (54, "M3B5", "C1081-Q9582", 52.761, "Morropón", "San Juan de Bigote", 0, 12),
    (55, "M3B7", "C1081-Q9582", 122.987, "Morropón", "San Juan de Bigote", 1, 12),
    (56, "M11B3", "C1081-Q9583", 106.059, "Morropón", "San Juan de Bigote", 1, 12),
    (57, "M30B6", "C1081-Q9591", 80.218, "Huancabamba", "Huancabamba", 1, 13),
    (58, "M30B1", "C1081-Q9591", 664.828, "Huancabamba", "Canchaque", 0, 13),
    (59, "M30B5", "C1081-Q9591", 107.389, "Huancabamba", "Huancabamba", 0, 13),
    (60, "M7B2", "C1076-Q9581", 115.422, "Morropón", "Salitral", 1, 14),
    (61, "M7B6", "C1076-Q9581", 91.317, "Morropón", "Salitral", 0, 14),
    (62, "M7B3", "C1076-Q9581", 65.768, "Morropón", "Salitral", 1, 14),
    (63, "M20B1", "C1076-Q9585", 279.766, "Huancabamba", "San Miguel de El Faique", 0, 14),
    (64, "M2B8", "C1076-Q9584", 116.136, "Huancabamba", "San Miguel de El Faique", 0, 14),
    (65, "M2B1", "C1076-Q9584", 81.823, "Morropón", "Salitral", 0, 14),
    (66, "M26B4", "C1076-Q9587", 36.946, "Huancabamba", "Canchaque", 0, 15),
    (67, "M11B2", "C1081-Q9583", 48.988, "Huancabamba", "Canchaque", 0, 15),
    (68, "M22B1", "C1076-Q9586", 61.447, "Huancabamba", "San Miguel de El Faique", 1, 15),
    (69, "M12B1", "C1076-Q9588", 590.622, "Huancabamba", "Huarmaca", 0, 16),
    (70, "M4B1", "C1076-Q9589", 37.034, "Huancabamba", "Huarmaca", 0, 16),
    (71, "M12B8", "C1076-Q9588", 473.542, "Morropón", "Salitral", 1, 16),
    (72, "M4B4", "C1076-Q9589", 290.0, "Huancabamba", "Huarmaca", 0, 16),
    (73, "M4B3", "C1076-Q9589", 234.137, "Huancabamba", "Huarmaca", 0, 16),
    (74, "M2B5", "C1076-Q9584", 30.918, "Morropón", "Salitral", 0, 16),
    (75, "M12B2", "C1076-Q9588", 55.463, "Huancabamba", "Huarmaca", 1, 17),
    (76, "M12B6", "C1076-Q9588", 101.408, "Huancabamba", "Huarmaca", 1, 17),
    (77, "M12B7", "C1076-Q9588", 49.703, "Huancabamba", "Huarmaca", 1, 17),
    (78, "M12B3", "C1076-Q9588", 346.064, "Huancabamba", "Huarmaca", 1, 17),
    (79, "M12B4", "C1076-Q9588", 207.944, "Huancabamba", "Huarmaca", 1, 18),
    (80, "M15B2", "C1076-Q9592", 101.409, "Huancabamba", "Huarmaca", 1, 18),
    (81, "M15B1", "C1076-Q9592", 135.22, "Huancabamba", "Huarmaca", 1, 18),
    (82, "M12B5", "C1076-Q9588", 64.986, "Huancabamba", "Huarmaca", 1, 18),
    (83, "M15B5", "C1076-Q9592", 135.664, "Huancabamba", "Huarmaca", 1, 19),
]

# Diccionario para búsqueda rápida por código de bloque
...
class TabBloques(ttk.Frame):
    ...
    def _crear_widgets(self):
        ...
        panel_izq_outer = ttk.Frame(self)
        panel_izq_outer.pack(side="left", fill="y", padx=(0, 4))

        canvas_izq = tk.Canvas(panel_izq_outer, bg=COLOR_FONDO, highlightthickness=0, width=380)
        scrollbar_izq = ttk.Scrollbar(panel_izq_outer, orient="vertical", command=canvas_izq.yview)
        panel_izq = ttk.Frame(canvas_izq, padding=10)

        panel_izq.bind("<Configure>",
                       lambda e: canvas_izq.configure(scrollregion=canvas_izq.bbox("all")))
        canvas_izq.create_window((0, 0), window=panel_izq, anchor="nw")
        ...
        # ── Selector rápido de los 83 bloques preliminares ──
        ttk.Label(panel_izq, text="Selección rápida - 83 Bloques:",
                  font=("Segoe UI", 9, "bold")).grid(
            row=1, column=0, columnspan=2, sticky="w", pady=(4, 2))
        self.combo_bloque_83 = ttk.Combobox(
            panel_izq, values=[""] + BLOQUES_83_OPCIONES, state="readonly", width=46)
        self.combo_bloque_83.grid(row=2, column=0, columnspan=2, sticky="ew", pady=(0, 2), padx=(0, 0))
        self.combo_bloque_83.bind("<<ComboboxSelected>>", self._on_bloque_83_seleccionado)

        self.label_info_83 = ttk.Label(panel_izq, text="", wraplength=360,
                                        foreground="#2980B9", font=("Segoe UI", 8))
        self.label_info_83.grid(row=3, column=0, columnspan=2, sticky="w", pady=(0, 6))

        ttk.Separator(panel_izq, orient="horizontal").grid(
        ...
        self.entries = {}
        for i, (label, key) in enumerate(campos, 5):
    ...
    def _on_bloque_83_seleccionado(self, event=None):
        """Autocompleta campos al seleccionar un bloque de los 83 predefinidos."""
        seleccion = self.combo_bloque_83.get()
        if not seleccion:
        ...
        # Limpiar formulario sin resetear defaults
        self.limpiar_formulario(reset_defaults=False)

        # Autocompletar campos
        self.entries["codigo"].insert(0, datos["codigo"])
        self.entries["cuenca"].insert(0, "Cuenca Alta del Río Piura")
        self.entries["area"].insert(0, str(datos["area_ha"]))
        self.entries["utm_zona"].insert(0, "17S")
        self.entries["altitud"].insert(0, "0")

        # Microcuenca
        if datos["microcuenca"] in MICROCUENCAS:
            self.combo_microcuenca.set(datos["microcuenca"])

        # Provincia y distrito
        if datos["provincia"] in PROVINCIAS:
            self.combo_provincia.set(datos["provincia"])
            self.combo_distrito["values"] = PROVINCIAS_DISTRITOS.get(datos["provincia"], DISTRITOS_PIURA)
        distrito = datos["distrito"]
        if distrito in DISTRITOS_PIURA:
            self.combo_distrito.set(distrito)

        # Info
        acc = "Acceso limitado" if datos["accesibilidad"] == 1 else "Acceso normal"
        self.label_info_83.config(
            text=f"Bloque {datos['codigo']} | {datos['microcuenca']} | "
                 f"{datos['distrito']} ({datos['provincia']}) | "
                 f"{datos['area_ha']} ha | {acc} | Día eval.: {datos['dia_evaluacion']}")
